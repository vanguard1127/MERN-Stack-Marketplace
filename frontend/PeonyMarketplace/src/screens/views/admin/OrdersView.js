...
import { getAllOrders } from './../../../services/api/httpclient';
...
class OrdersView extends Component {
    ...
    onItemClick = (rowData) => {
      this.props.navigation.navigate('OrderDetailAdmin' , {
        id:rowData._id
      });
    }
    renderFooter = () => {
          ...
          return(
            ...
            >
              ...
              <Body>
                ...
                <Text style={{fontSize: 16, fontWeight: 'bold', marginBottom: 10}}>{item.status}</Text>                
              </Body>
              <Right>
    ...
    render() {
        ...
        return (
              <View style={styles.container}>
                   ...
                   <Navbar left={left} title="All Orders" />   
                   <ScrollableTabView
                    style={{marginTop: 5, }}
                    initialPage={1}
