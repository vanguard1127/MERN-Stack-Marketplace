...
import {
    ...
    TouchableHighlight,
    Image,
    Alert,FlatList,RefreshControl,Platform,
    ActivityIndicator,
} from 'react-native';
...
class MyBuyOrdersView extends Component {
    constructor(props) {
        super(props);
        this.state = {
            none_orders:[],
    ...
    render() {
        ...
        return (
              <View style={styles.container}>
                   ...
                   <Navbar left={left} title="MyOrders" />   
                  <ScrollableTabView
                    style={{marginTop: 5, }}
                    initialPage={1}
                      ...
                      <View style={[styles.scene]} tabLabel='Shipped'>
                        <FlatList
                          ...
                          refreshControl={
                              ...
                              />}
                          keyExtractor={(item, index) =>'T' + index.toString()}
                          onEndReachedThreshold={0.4}     
                          ItemSeparatorComponent={this.renderSeparator}                   
                          ListFooterComponent={this.renderFooter.bind(this)}
  ...
  export default withNavigationFocus(MyBuyOrdersView);
