...
WalletTableToolbar.propTypes = {
  classes: PropTypes.object.isRequired,  
};

WalletTableToolbar = withStyles(toolbarStyles)(WalletTableToolbar);
...
class WalletTable extends React.Component {
  ...
  handleEditClick = (event, id) => {    
    this.props.history.push('/points_edit/' +id);
  };
  ...
  render() {
    ...
    return (
      <Paper className={classes.root}>
        <WalletTableToolbar  title={this.props.title}/>
                ...
                .map(n => {                  
                  return (
                    ...
                    >                      
                      ...
                      <TableCell align="center">{n.points.points}</TableCell>                                         
