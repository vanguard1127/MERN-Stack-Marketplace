  ...
  render() {
    ...
    return (
      <Paper className={classes.root}>
        <UserTableToolbar  title={this.props.title}/>
                ...
                .map(n => {                  
                  return (
                    ...
                    >                      
                      ...
                      <TableCell align="center">{n.first_name}</TableCell>
                      <TableCell align="center">{n.last_name}</TableCell>
                      <TableCell align="center">{n.email}</TableCell>
                      <TableCell align="center">{n.phone_number}</TableCell>                      
                      <TableCell align="center">{n.verification}</TableCell>                      
                      <TableCell align="center">{n.user_type}</TableCell>                      
                      <TableCell align="center">{n.photo}</TableCell>                      
                      <TableCell align="center">{n.country}</TableCell>                      
                      <TableCell align="center">{n.state}</TableCell>                      
                      <TableCell align="center">{n.line1}</TableCell>                      
                      <TableCell align="center">{n.line2}</TableCell>                      
