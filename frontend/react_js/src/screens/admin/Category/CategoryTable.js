    ...
    >
      ...
      <div className={classes.actions}> 
          <Tooltip title="Add Category">
              <IconButton aria-label="Add Category" onClick={ event => onAddClick(event)}>
                <AddIcon />
              </IconButton>
          </Tooltip>         
      </div>
...
class CategoryTable extends React.Component {
  ...
  handleEditClick = (event, id) => {    
    this.props.history.push('/category_edit/' +id);
  };
  ...
  render() {
    ...
    return (
      <Paper className={classes.root}>
        <CategoryTableToolbar  title={this.props.title} onAddClick = {this.handleAddClick}/>
