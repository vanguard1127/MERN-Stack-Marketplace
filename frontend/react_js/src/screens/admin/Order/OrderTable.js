...
let CategoryTableToolbar = props => {
  const { classes} = props;
...
CategoryTableToolbar = withStyles(toolbarStyles)(CategoryTableToolbar);
...
class CategoryTable extends React.Component {
  ...
  handleEditClick = (event, id) => {    
    this.props.history.push('/orders_edit/' +id);
  };
  ...
  render() {
    ...
    return (
      <Paper className={classes.root}>
        <CategoryTableToolbar  title={this.props.title} />
                ...
                .map(n => {                  
                  return (
                    ...
                    >                      
                      ...
                      <TableCell align="center">{n.buyer_id.first_name + ' ' + n.buyer_id.last_name}</TableCell>                                         
                      <TableCell align="center">{n.status}</TableCell>                                         
                      <TableCell align="center">{n.confirmed_date}</TableCell>                                         
                      <TableCell align="center">{n.shipped_date}</TableCell>                                         
                      <TableCell align="center">{n.delivered_date}</TableCell>                                         
                      <TableCell align="center">
                                {<IconButton onClick={ event => this.handleDeleteClick(event, n._id)}>
                                    <DeleteIcon color="secondary" />
                                  </IconButton>}
                                  
                                {<IconButton onClick={ event => this.handleEditClick(event, n._id)}>
